...
import { useGetClientsByAddressQuery } from "../../services/services";
import Container from "../../layouts/Container";
import CardItems from "./components/CardItems";
import AddClient from "./components/AddClient";

interface IUsersListsContainerProps {
  selected: string;
}

const UsersListsContainer: FC<IUsersListsContainerProps> = ({ selected }) => {
